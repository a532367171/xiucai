<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="DirManager.aspx.cs" Inherits="Xiucai.BPM.Admin.QrMcodeManager.DirManager" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="layout">
        <div region="west" style="width:200px;border-right: 0px;" border="true">
            <div class="easyui-panel" title="二维码类别" border="false" iconCls="icon-book_red" >
