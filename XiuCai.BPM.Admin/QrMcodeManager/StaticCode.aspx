<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="StaticCode.aspx.cs" Inherits="Xiucai.BPM.Admin.QrMcodeManager.StaticCode" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <div id="layout">
        <div region="west" iconCls="icon-chart_organisation" split="true" title="静态码目录" style="width:220px;padding: 5px" collapsible="false">
            <ul id="deptree"></ul>
        </div>
        <div region="center" title="静态码" iconCls="icon-users" style="padding: 2px; overflow: hidden">
            <div id="toolbar">
               <%=base.BuildToolbar() %>
